...
if($_SERVER['REQUEST_METHOD']=='GET'){
   ...
   $sql1="INSERT INTO `manager_tab`(`manager_firstName`,`manager_lastName`,`manager_emailId`,`manager_pass`,`manager_contact`,`manager_city`,`manager_state`,`manager_country`) VALUES ('$manager_firstName','$manager_lastName','$manager_emailId','$manager_pass','$manager_contact','$manager_city','$manager_state','$manager_country')";
