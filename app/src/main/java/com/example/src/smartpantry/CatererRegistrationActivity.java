...
public class CatererRegistrationActivity extends AppCompatActivity{
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((fname.length() != 0) && (lname.length() != 0) && (em.length() != 0) && (pass.length() != 0) && (contactnum.length() != 0) && (city.length() != 0) && (state.length() != 0) && (country1.length() != 0)) {
                    ...
                    int count = insertUser3(fname, lname, em, pass, contactnum, city, state, country1);
                    Toast.makeText(CatererRegistrationActivity.this, "registration success"+count, Toast.LENGTH_LONG).show();

                    Intent intent = new Intent(CatererRegistrationActivity.this, CatrLoginactivity.class);
    ...
    private int insertUser3(String fnm1, String lnm1, String emailid1, String pas1, String contact1, String cityy1, String stat1, String country1) {

        final int[] res = {0};

        Call<Caterer> call = apiInterface.insertUser3(fnm1, lnm1, emailid1, pas1, contact1, cityy1, stat1, country1);
        call.enqueue(new Callback<Caterer>() {
            @Override
            public void onResponse(Call<Caterer> call, Response<Caterer> response) {
            ...
            @Override
            public void onFailure(Call<Caterer> call, Throwable t) {
